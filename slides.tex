...
\makecommand{\doequil}{\includegraphics[width=1cm]{pic/equilibrium.jpg}}
...
\begin{figure}
\subfigure[$V(\vecx) \leq 1$]{ \includegraphics[width=.35\linewidth]{pic/sublevel_one} }
\subfigure[$V(\vecx) \leq 1/2$]{ \includegraphics[width=.35\linewidth]{pic/sublevel_half} }
\subfigure[$V(\vecx) \leq 1/4$]{ \includegraphics[width=.35\linewidth]{pic/sublevel_quarter} }
\subfigure[$V(\vecx) \leq 1/10$]{ \includegraphics[width=.35\linewidth]{pic/sublevel_tenth} }
\end{figure}
